					...
					<form name="myForm" class="form-horizontal">
							...
							<div class="col-md-6 form-group">
								...
								<div class="col-md-8">
									<input type="text" name="txtContactNumber" id="contact-number"
										...
										ng-disabled="!one.enableControl(('${sessionScope.UserGroup[0].division}'| lowercase))"
										class="form-control" />
								</div>
							</div>
							<div class="col-md-6 form-group">
							...
							<div class="col-md-6 form-group">
								...
								<div class="col-md-8">
									<select name="solutionConstrain" id="solutionConstrain"
										...
										('${sessionScope.UserGroup[0].division}'| lowercase) == 'technology')"
										class="form-control">
						...
						<div class="row">
							<div class="col-md-6 form-group">
								...
								<div class="col-md-7">
									<div class="radio">
										<fieldset ng-disabled="!one.enableControl(('${sessionScope.UserGroup[0].division}'| lowercase))">
						...
						<div class="col-md-3">
								<button type="button" 
									class="btn btn-primary btn-block form-control"
									ng-click="one.gotoRO(one.complaint.ticketNumber)">Go To RO Form</button>
							</div>
					...
					<thead>
						<tr>
							...
							<th ng-click="predicate='active'; reverse=!reverse">User
								Group</th>
							<th ng-click="predicate='active'; reverse=!reverse">Hop Status</th>
